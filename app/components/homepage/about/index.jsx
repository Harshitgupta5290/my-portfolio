...
const aboutStats = [
  { value: "3+", label: "Years Experience", back: "Backend & AI" },
  { value: "20+", label: "Microservices Built", back: "Production Grade" },
  { value: "5+", label: "AI Projects", back: "LLMs & Vision" },
  { value: "6", label: "Certifications", back: "Oracle & More" },
];
